...
describe('EditorNavbar', () => {
  describe('rendering', () => {
    it('renders EditorNavbar', () => {
      ...
      const navbar = screen.getByRole('navigation', { name: "Editor Tabs" });
      expect(navbar).toBeInTheDocument();
      expect(navbar).toHaveClass('pf-v5-c-nav', 'pf-m-horizontal', 'nav', 'nav-tabs', 'nav-tabs-pf', 'nav-tabs-pf5-secondary');
    })
  })
